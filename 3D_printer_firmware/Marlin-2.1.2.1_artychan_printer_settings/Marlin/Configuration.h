...
#define HEATER_0_MAXTEMP 285 // ARTYCHAN 
...
#define BED_MAXTEMP      100  // ARTYCHAN
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // ARTYCHAN
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define FIL_RUNOUT_STATE     HIGH     // ARTYCHAN   // Pin state indicating that filament is NOT present.
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 25 // ARTYCHAN
 ...
 */
#define NOZZLE_PARK_FEATURE // ARTYCHAN
