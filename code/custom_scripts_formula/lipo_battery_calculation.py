...
class BatteryCalculation:
    ...
    def get_user_input(self):
        ...
        self.discharge_capacity = float(input("The Discharge Capacity (mAh) of the battery is: "))
        ...
        if (self.voltage_output < 0) or (self.discharge_capacity < 0) or (self. discharge_rate < 0):
    ...
    def max_amp_rating(self):
        ...
        self.discharge_current = (self.discharge_capacity / 1000.0) * self.discharge_rate
    ...
    def battery_expectancy_time(self):
        ...
        # Getting the time
        self.battery_time = 60 / self.discharge_rate

        # Printing the output
        print(f"The battery will last about: {self.battery_time} mins")
    ...
    def plotting_battery_time(self):
        ...
        current_draw_array = [(60 / counter_index) for counter_index in current_draw_array]
